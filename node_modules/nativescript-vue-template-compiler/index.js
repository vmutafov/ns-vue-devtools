...
/*!
 * NativeScript-Vue-Template-Compiler v2.9.0
 * (Using Vue v2.6.12)
...
function parseComponent(
  ...
  function end(tag, start, end) {
    if (depth === 1 && currentBlock) {
      ...
      var text = deindent__default['default'](content.slice(currentBlock.start, currentBlock.end));
...
var prototypeAccessors$3 = { child: { configurable: true } };

// DEPRECATED: alias for componentInstance for backwards compat.
/* istanbul ignore next */
prototypeAccessors$3.child.get = function () {
  return this.componentInstance
};

Object.defineProperties( VNode.prototype, prototypeAccessors$3 );
...
process.env.VUE_VERSION || '2.6.12';
process.env.NS_VUE_VERSION || '2.9.0';
...
var prototypeAccessors = { selectorFn: { configurable: true } };
...
prototypeAccessors.selectorFn.get = function () {
  var self = this;
...
Object.defineProperties( TemplateBag.prototype, prototypeAccessors );
...
var prototypeAccessors$1 = { key: { configurable: true } };
...
Object.defineProperties( VueKeyedTemplate.prototype, prototypeAccessors$1 );
  ...
  props: {
    items: {
      ...
      validator: function (val) {
        var ObservableArray = require('@nativescript/core').ObservableArray;
...
registerElement('ActionBar', function () { return require('@nativescript/core').ActionBar; }, {
...
registerElement('ActionItem', function () { return require('@nativescript/core').ActionItem; });
...
registerElement('ListView', function () { return require('@nativescript/core').ListView; }, {
  component: listView
});

registerElement(
  'NavigationButton',
  function () { return require('@nativescript/core').NavigationButton; }
);

registerElement('TabView', function () { return require('@nativescript/core').TabView; }, {
  model: {
    prop: 'selectedIndex',
    event: 'selectedIndexChange'
  },
...
registerElement(
  'TabViewItem',
  function () { return require('@nativescript/core').TabViewItem; },
  {
    skipAddToDom: true,
...
registerElement('Label', function () { return require('@nativescript/core').Label; }, {
  model: {
    prop: 'text',
    event: 'textChange'
  }
...
registerElement('DatePicker', function () { return require('@nativescript/core').DatePicker; }, {
  model: {
    prop: 'date',
    event: 'dateChange'
  }
...
registerElement(
  'AbsoluteLayout',
  function () { return require('@nativescript/core').AbsoluteLayout; }
);
registerElement(
  'ActivityIndicator',
  function () { return require('@nativescript/core').ActivityIndicator; }
);
registerElement('Button', function () { return require('@nativescript/core').Button; });
registerElement('ContentView', function () { return require('@nativescript/core').ContentView; });
registerElement('DockLayout', function () { return require('@nativescript/core').DockLayout; });
registerElement('GridLayout', function () { return require('@nativescript/core').GridLayout; });
registerElement('HtmlView', function () { return require('@nativescript/core').HtmlView; });
registerElement('Image', function () { return require('@nativescript/core').Image; });
registerElement('img', function () { return require('@nativescript/core').Image; });
registerElement('ListPicker', function () { return require('@nativescript/core').ListPicker; }, {
  model: {
    prop: 'selectedIndex',
    event: 'selectedIndexChange'
  }
});
registerElement('Page', function () { return require('@nativescript/core').Page; }, {
  skipAddToDom: true,
  component: page
});

registerElement('Placeholder', function () { return require('@nativescript/core').Placeholder; });
registerElement('Progress', function () { return require('@nativescript/core').Progress; }, {
  model: {
    prop: 'value',
    event: 'valueChange'
  }
...
registerElement(
  'ProxyViewContainer',
  function () { return require('@nativescript/core').ProxyViewContainer; }
);
// registerElement(
//   'Repeater',
...
registerElement(
  'SegmentedBar',
  function () { return require('@nativescript/core').SegmentedBar; },
  {
    model: {
      prop: 'selectedIndex',
      event: 'selectedIndexChange'
...
registerElement(
  'SegmentedBarItem',
  function () { return require('@nativescript/core').SegmentedBarItem; }
);
registerElement('Slider', function () { return require('@nativescript/core').Slider; }, {
  model: {
    prop: 'value',
    event: 'valueChange'
  }
});
registerElement('StackLayout', function () { return require('@nativescript/core').StackLayout; });
registerElement(
  'FlexboxLayout',
  function () { return require('@nativescript/core').FlexboxLayout; }
);
registerElement('Switch', function () { return require('@nativescript/core').Switch; }, {
  model: {
    prop: 'checked',
    event: 'checkedChange'
  }
...
registerElement('TextField', function () { return require('@nativescript/core').TextField; }, {
  model: {
    prop: 'text',
    event: 'textChange'
  }
});
registerElement('TextView', function () { return require('@nativescript/core').TextView; }, {
  model: {
    prop: 'text',
    event: 'textChange'
  }
});
registerElement('TimePicker', function () { return require('@nativescript/core').TimePicker; }, {
  model: {
    prop: 'time',
    event: 'timeChange'
  }
});
registerElement('WebView', function () { return require('@nativescript/core').WebView; });
registerElement('WrapLayout', function () { return require('@nativescript/core').WrapLayout; });
registerElement(
  'FormattedString',
  function () { return require('@nativescript/core').FormattedString; },
  {
...
registerElement('Span', function () { return require('@nativescript/core').Span; });
...
registerElement(
  'DetachedText',
  function () { return require('@nativescript/core').Placeholder; },
  {
    skipAddToDom: true
  }
);
registerElement('Comment', function () { return require('@nativescript/core').Placeholder; });
...
registerElement('Frame', function () { return require('@nativescript/core').Frame; }, {
  insertChild: function insertChild(parentNode, childNode, atIndex) {
...
var modules = [class_$1, style$1, vTemplate, for_, router, view];
